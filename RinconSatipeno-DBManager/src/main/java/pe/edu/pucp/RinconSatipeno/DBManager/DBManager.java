package pe.edu.pucp.RinconSatipeno.DBManager;
...
public class DBManager {
    ...
    public Connection getConnection() throws SQLException {
        String url = "jdbc:mysql://" + servidor + ":" + puerto + "/" + esquema + "?useSSL=false&allowPublicKeyRetrieval=true";
